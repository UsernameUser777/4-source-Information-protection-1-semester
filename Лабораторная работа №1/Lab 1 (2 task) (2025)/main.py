...
# Ключевое слово (лозунг) для формирования алфавита замены
# Повторяющиеся буквы в ключе будут исключены
keyword = "ДЯДИНА"
...
def generate_cipher_alphabet(keyword, original_alphabet):
    ...
    :param case_sensitive: Учитывать ли регистр при удалении дубликатов из ключа (bool).
...
print(f"Алфавит замены (таблица шифрозамен): {generate_cipher_alphabet(keyword, alphabet)}")
